...
public class UserIconCreater {
    ...
    /** 保存路径 */
    private final static String staticPath = ClassUtils.getDefaultClassLoader().getResource("static").getPath();



    public static String getIconPath() throws IOException{
        //得到图片缓冲区
        ...
        // 图片存储目录及图片名称
        String url_path = "img" + File.separator + iconName;
        ...
        ImageIO.write(bi,"PNG",
                new FileOutputStream(savePath.toString()));//保存图片 PNG表示保存格式
